...
## functions do
## The makeCacheMatrix function creates a list that caches values

## The first function, makeCacheMatrix creates a list containing functions that do the following:
